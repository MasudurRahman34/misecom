...
<div class="panel panel-default" id="ajax_cart_table">
    <!--start ajax_cart_table -->
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            @endif --}}
            <td class="text-center" style="max-width: 130px;"><a href="{{ route('product.show',[$cart->product->slug] ) }}"> <img style="max-width: 75%; class="img-thumbnail" title="iPhone" alt="iPhone" src="{{ asset('img/product/'.$cart->product->product_images->first()->link) }}"></a></td>
