                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner img-hover-zoom">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('frontend/image/product/product2.jpg') }}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('frontend/image/product/product3.jpg') }}" alt="Third slide">
                                </div>
                                {{-- need-change --}}
                            </div>
