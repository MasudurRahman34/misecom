                ...
                <li class="header-notification">
                    <div class="dropdown-primary dropdown">
                        ...
                        <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            ...
                            <li>
                                <div class="media">
                                    <img class="d-flex align-self-center img-radius" src="{{ asset('backend/files/assets/images/avatar-4.jpg') }}" alt="Generic placeholder image">
                            ...
                            <li>
                                <div class="media">
                                    <img class="d-flex align-self-center img-radius" src="{{ asset('backend/files/assets/images/avatar-3.jpg') }}" alt="Generic placeholder image">
                                    <div class="media-body">
